...
class ChargingRequest
{
    ...
    function __construct($wc_settings)
    {
        ...
        $this->set_merchant_key_id($wc_settings['merchant_key_id']);
        $this->set_transaction_type('SALE');
        $this->set_ui_mode($wc_settings['ui_mode']);
        $this->set_hash_method($wc_settings['hash_method']);
        $this->set_currency('INR');
    ...
    {
        return $this->params[PZ_Constants::PARAMETER_UI_MODE];
    }
    ...
    private function validate()
    {
        ...
        if (!PZ_Utils::is_valid_parameter($this->params[PZ_Constants::PARAMETER_TRANSACTION_AMOUNT])
            ...
            echo "trsanction amount " . $this->params[PZ_Constants::PARAMETER_TRANSACTION_AMOUNT];
